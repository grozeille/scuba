package fr.grozeille.scuba.user.web;

import fr.grozeille.scuba.admin.model.AdminUser;
import fr.grozeille.scuba.admin.repositories.AdminUserRepository;
import fr.grozeille.scuba.project.model.Project;
import fr.grozeille.scuba.project.repositories.ProjectRepository;
import fr.grozeille.scuba.user.model.User;
import fr.grozeille.scuba.user.model.UserProject;
import fr.grozeille.scuba.user.repositories.UserRepository;
import fr.grozeille.scuba.user.repositories.UserWithProjectRepository;
import fr.grozeille.scuba.user.web.dto.SetLastProjectRequest;
